...
let shoeName = document.getElementById('shoeName');

// used for parsing shoes
let i = 0;

class Shoes{
    constructor(main, circle, floatingImage, leftContainer, rightContainer, shoeName){
    ...
    prev(){
        ...
        this.shoeName.innerHTML = this.shoesCollection[i].name;
